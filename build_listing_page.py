  ...
  <header class="navbar">
    <div class="nav-container">
      ...
      <ul class="nav-menu">
        ...
        <li><a href="javascript:void(0)" onclick="selectCategory('dien-san', document.querySelector('[data-cat=dien-san]'))">Điền Sản (12 Lô)</a></li>
        <li><a href="javascript:void(0)" onclick="selectCategory('dien-an', document.querySelector('[data-cat=dien-an]'))">Điền An (7 Cụm)</a></li>
        <li><a href="javascript:void(0)" onclick="selectCategory('biet-phu-dien-trang', document.querySelector('[data-cat=biet-phu-dien-trang]'))">Biệt Phủ (17 Căn)</a></li>
        <li>
          <a href="article.html?id=304" class="btn-cta-nav">
            <i class="fa-solid fa-calendar-check"></i> Đăng Ký Khảo Sát
          </a>
        </li>
      </ul>
    </div>
