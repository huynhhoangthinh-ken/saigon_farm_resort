  ...
  <header class="navbar">
    <div class="nav-container">
      ...
      <ul class="nav-links">
        ...
        <li><a href="listing.html" class="active"><i class="fa-solid fa-cart-shopping" style="color:var(--gold-dark);"></i> Giỏ Hàng Mở Bán</a></li>
  ...
  <section class="listing-hero">
    ...
    <div class="hero-container">
      <div class="breadcrumbs">
        ...
        <span>Giỏ Hàng & Bảng Giá Mở Bán Đợt 1</span>
      </div>
