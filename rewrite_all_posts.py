...
"""
    ...
    {
        "id": 301,
        "title": "Về Ban Quản Lý Saigon Farm Resort & Đơn Vị Tiếp Thị Phân Phối Độc Quyền",
        "excerpt": "Ban Quản Lý Saigon Farm Resort là thương hiệu tư vấn, tiếp thị và phân phối bất động sản nghỉ dưỡng sinh thái và cao cấp hàng đầu với triết lý phụng sự tận tâm.",
        "image": "assets/brand/hcmc_skyline_luxury.jpg",
        "date": "29 TH8 2026",
        "content": """
<p><strong>Ban Quản Lý Saigon Farm Resort</strong> tự hào là Đơn vị Tổng Đại Lý Tiếp Thị & Phân Phối độc quyền cho khu nghỉ dưỡng sinh thái <strong>Saigon Farm Resort</strong>. Chúng tôi cam kết mang lại giải pháp tư vấn đầu tư, quy hoạch chuẩn xác và an cư thịnh vượng nhất cho quý khách hàng.</p>

<div style="margin: 24px 0; text-align: center;">
  <img src="assets/brand/hcmc_skyline_luxury.jpg" alt="Thành phố Hồ Chí Minh - Trụ sở & Trung tâm kết nối Ban Quản Lý Saigon Farm Resort" style="width: 100%; border-radius: 8px; box-shadow: 0 4px 15px rgba(0,0,0,0.1);">
  <p style="font-size: 0.88rem; color: #777; margin-top: 8px; font-style: italic;">Ban Quản Lý Saigon Farm Resort — Đơn vị tư vấn & tiếp thị bất động sản nghỉ dưỡng cao cấp tại TP. Hồ Chí Minh</p>
</div>
...
<p>🏢 <strong>Ban Quản Lý Saigon Farm Resort</strong> — Đơn vị tư vấn và phân phối bất động sản nghỉ dưỡng sinh thái cao cấp.</p>
...
"""
    },
    {
        ...
        "excerpt": "Ban Quản Lý Saigon Farm Resort chào đón những tài năng nhiệt huyết, có tư duy dịch vụ thượng lưu và khao khát khẳng định bản thân trong phân khúc BĐS cao cấp.",
        "image": "assets/Index_asset/Phoicanh/SFR_1.jpg",
        "date": "29 TH8 2026",
        "content": """
<p>Bạn đam mê lĩnh vực bất động sản nghỉ dưỡng cao cấp? Bạn muốn làm việc trong môi trường chuyên nghiệp với những khách hàng thượng lưu và thu nhập không giới hạn? Hãy gia nhập đội ngũ <strong>Ban Quản Lý Saigon Farm Resort</strong> ngay hôm nay!</p>
...
<article class=\"article-detail\" style=\"font-family: var(--font-sans); color: #2c2c2c; line-height: 1.85; max-width: 900px; margin: 0 auto;\">
  ...
  <div style=\"background: linear-gradient(135deg, #18221b 0%, #25382b 100%); color: #fff; border-left: 4px solid #c9a96e; padding: 24px 28px; border-radius: 8px; margin: 30px 0; box-shadow: 0 8px 24px rgba(0,0,0,0.12);\">
    ...
    <ul style=\"margin: 0; padding-left: 20px; font-size: 0.98rem; line-height: 1.8;\">
      ...
      <li><strong>Tư vấn chuyên sâu & Chính sách ưu đãi:</strong> Cung cấp đầy đủ hồ sơ pháp lý sổ đỏ, bảng quy hoạch chi tiết và chính sách ưu đãi mở bán trực tiếp từ <strong>Ban Quản Lý Saigon Farm Resort</strong> và <strong>MDS Living</strong>.</li>
    </ul>
  </div>
  ...
  <!-- Section 1 -->
  <h2 style=\"font-family: var(--font-serif); font-size: 1.65rem; color: #111; margin-top: 40px; margin-bottom: 18px; border-bottom: 1px solid #e8e8e8; padding-bottom: 10px;\">
    1. Vì Sao Nên Trực Tiếp Tham Quan Thực Địa Điền Trang?
  </h2>
    ...
    <table style=\"width: 100%; border-collapse: collapse; font-size: 0.95rem; background: #fff; box-shadow: 0 4px 16px rgba(0,0,0,0.06); border-radius: 8px; overflow: hidden;\">
      ...
      <tbody>
        ...
        <tr style=\"background: #faf8f5;\">
          ...
          <td style=\"padding: 14px 16px; border: 1px solid #e8e8e8; font-weight: 700; color: #1a1a1a;\">Đến Điền Trang & Thưởng Trà Đón Tiếp</td>
        ...
        <tr>
          ...
          <td style=\"padding: 14px 16px; border: 1px solid #e8e8e8; color: #444;\">Chuyên viên Saigon Farm Resort & MDS Living tư vấn giải pháp tài chính, phương án khai thác cho thuê và chính sách chiết khấu.</td>
        </tr>
        <tr style=\"background: #faf8f5;\">
  ...
  <div style=\"background: #111; color: #fff; padding: 32px 36px; border-radius: 8px; border-left: 5px solid #c9a96e; margin: 30px 0; box-shadow: 0 10px 30px rgba(0,0,0,0.2);\">
    <div style=\"display: flex; justify-content: space-between; align-items: center; flex-wrap: wrap; gap: 15px; border-bottom: 1px solid #333; padding-bottom: 18px; margin-bottom: 20px;\">
      <div>
        ...
        <h3 style=\"margin: 4px 0 0 0; font-family: var(--font-serif); font-size: 1.45rem; color: #fff;\">SAIGON FARM RESORT</h3>
      </div>
      <div>
    ...
    <div style=\"font-size: 0.96rem; line-height: 1.8; color: #ddd; margin-bottom: 24px;\">
      <p style=\"margin-bottom: 8px;\">📍 <strong>Địa chỉ điền trang:</strong> Xã Đất Đỏ, Huyện Đất Đỏ, Tỉnh Bà Rịa – Vũng Tàu (Cách Hồ Tràm 15 phút).</p>
