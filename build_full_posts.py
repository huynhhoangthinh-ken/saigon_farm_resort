...
"""
    ...
    },
    {
        ...
        "excerpt": "Trải nghiệm nghệ thuật ẩm thực tinh hoa thuần khiết từ nông trại hữu cơ Organic Farm và hồ nước tự nhiên. Bữa tiệc giữa đồng lúa chín và bàn ăn ấm cúng gắn kết ba thế hệ gia đình.",
        "image": "assets/Index_asset/Tien_ich_minh_hoa/Nong_trai_huu_co.png",
        "date": "30 TH8 2026",
        "content": "\n<p>Ẩm thực của người Việt không đơn thuần là sự nạp năng lượng, mà là một <strong>nghệ thuật cân bằng âm dương và sợi dây tình cảm thiêng liêng gắn kết các thành viên gia đình</strong>. Tại không gian <em>Nếp Nhà Việt (The Vietnamese Table)</em> và <em>Nông Trại Hữu Cơ Organic Farm</em> của Saigon Farm Resort, triết lý Farm-to-Table được nâng tầm thành một trải nghiệm ẩm thực bản sắc đỉnh cao.</p>\n\n<div class=\"key-takeaways\">\n  <h3>Hành Trình Ẩm Thực Nguyên Bản Tại Saigon Farm Resort</h3>\n  <ul>\n    <li><strong>Tươi ngon nguyên bản từ vườn đến bàn ăn:</strong> Rau củ hữu cơ hái tại vườn, cá nước ngọt tự nhiên từ hồ 100ha, trứng gà thả đồi được thu hoạch mỗi sáng.</li>\n    <li><strong>Nghệ thuật ẩm thực tôn vinh gia vị bản địa:</strong> Lá é, rau thơm thảo dược, nước mắm truyền thống ủ chượp và gạo lúa mùa thơm lừng.</li>\n    <li><strong>Bàn ăn độc bản giữa thiên nhiên:</strong> Bàn tiệc hoàng hôn bên hồ sen ngát hương, tiệc nướng BBQ giữa đồng lúa chín và trà chiều dưới tán cây cổ thụ.</li>\n  </ul>\n</div>\n\n<h2>1. Trải Nghiệm Thu Hoạch & Cùng Nấu Cơm Gia Đình</h2>\n<p>Gia chủ và các em nhỏ có thể tự tay thu hoạch những luống rau xanh mướt, hái quả ngọt trong vườn nhà hoặc câu cá ven bờ hồ. Bếp trưởng riêng của khu nghỉ dưỡng sẽ đồng hành để cùng gia đình chế biến những món ăn truyền thống đậm đà phong vị quê hương nhưng được trình bày theo chuẩn Fine Dining quốc tế.</p>\n\n<div style=\"margin: 28px 0; text-align: center;\">\n  <img src=\"assets/Index_asset/Tien_ich_minh_hoa/Nong_trai_huu_co.png\" alt=\"Nông Trại Hữu Cơ Organic Farm\" style=\"width: 100%; border-radius: 8px; box-shadow: 0 4px 20px rgba(0,0,0,0.15);\">\n  <p style=\"font-size: 0.82rem; color: #888; text-align: center; margin-top: 6px; font-style: italic;\">Nông trại hữu cơ Organic Farm cung cấp nguồn thực phẩm sạch chuẩn Farm-to-Table (* Hình ảnh minh họa)</p>\n</div>\n\n<h2>2. Bữa Cơm Sum Vầy – Nơi Tình Thân Lan Tỏa</h2>\n<p>Không có âm thanh ồn ào của phố thị hay ánh đèn neon chói gắt, bữa tối tại điền trang diễn ra dưới ánh hoàng hôn dịu ngọt, gió hồ thoang thoảng và tiếng cười rộn rã của con cháu. Đó là lúc ký ức gia đình được khắc sâu và năng lượng yêu thương được tái tạo tròn đầy.</p>\n\n<div style=\"background: #111; color: #fff; padding: 28px; border-radius: 8px; border-left: 4px solid #c9a96e; margin-top: 30px;\">\n  <h4 style=\"margin-bottom: 8px; font-family: var(--font-serif); font-size: 1.25rem; color: #c9a96e;\">TỔNG ĐẠI LÝ TIẾP THỊ & PHÂN PHỐI: ĐẠI CHÚNG PROPERTIES</h4>\n  <p style=\"margin-bottom: 6px; font-size: 0.95rem;\">🏢 <strong>Phòng Kinh Doanh & Tư Vấn Dự Án:</strong> Saigon Farm Resort</p>\n  <p style=\"margin-bottom: 14px; font-size: 0.95rem;\">📞 <strong>Hotline / Zalo Tiếp Nhận Thông Tin:</strong> <a href=\"https://zalo.me/0906060036\" target=\"_blank\" style=\"color:#0068FF; font-weight:700; text-decoration:underline;\">0906060036</a></p>\n  <a href=\"https://zalo.me/0906060036\" target=\"_blank\" style=\"display: inline-flex; align-items: center; gap: 8px; background: #0068FF; color: #fff; padding: 12px 24px; border-radius: 4px; font-weight: 700; text-decoration: none;\">\n    <i class=\"fa-solid fa-comment-dots\"></i> Nhắn Zalo Nhận Bảng Giá & Đặt Lịch Trải Nghiệm\n  </a>\n</div>\n"
    },
    {
        "id": 209,
    ...
    },
    {
        ...
        "excerpt": "Tách con trẻ khỏi màn hình điện tử để chạm tay vào đất sét làm gốm, nặn tò he, viết thư pháp và thả diều trên đồi cỏ ven hồ tại Giáo Trí Việt và Vườn Cội.",
        "image": "assets/Index_asset/Tien_ich_minh_hoa/Giao_tri_viet.png",
        "date": "30 TH8 2026",
        "content": "\n<p>Một trong những nỗi trăn trở lớn nhất của các bậc phụ huynh thời hiện đại là con trẻ bị cuốn vào các thiết bị công nghệ, thiếu vắng không gian vận động ngoài trời và dần xa rời văn hóa cội nguồn. Tại phân khu <strong>Giáo Trí Việt (The Maker's House)</strong> và <strong>Vườn Cội (The Roots Garden)</strong>, trẻ em được trao tặng một tuổi thơ trọn vẹn và đậm chất nhân văn.</p>\n\n<div class=\"key-takeaways\">\n  <h3>Những Trải Nghiệm Đánh Thức Trí Tuệ & Cảm Xúc Của Trẻ</h3>\n  <ul>\n    <li><strong>Học làm gốm thủ công:</strong> Cảm nhận sự mềm mại của đất sét, rèn luyện tính kiên nhẫn và óc sáng tạo khi tự tay tạo nên chiếc cốc, chiếc bát xinh xắn.</li>\n    <li><strong>Nặn tò he & Thắt lá dừa nghệ thuật:</strong> Khám phá sắc màu dân gian rực rỡ và những hình tượng anh hùng cổ tích Việt Nam.</li>\n    <li><strong>Lớp học Thư pháp & Tranh Đông Hồ:</strong> Học về đạo làm người, chữ hiếu và nét cọ mực tàu uyển chuyển.</li>\n    <li><strong>Vườn Cội – Trồng cây gia đình:</strong> Mỗi đứa trẻ được tự tay vun trồng một cây xanh mang bảng tên gia đình, theo dõi cây lớn lên theo năm tháng.</li>\n  </ul>\n</div>\n\n<h2>1. Trao Truyền Tình Yêu Quê Hương Bằng Đôi Tay Khéo Léo</h2>\n<p>Không qua những bài giảng lý thuyết khô khan, tình yêu cội nguồn ngấm vào tâm hồn trẻ nhỏ một cách tự nhiên nhất khi các em được chạm tay vào bùn đất, hít thở hương thơm của lá dừa tươi và mỉm cười tự hào khi hoàn thành một sản phẩm thủ công đầu đời.</p>\n\n<div style=\"margin: 28px 0; text-align: center;\">\n  <img src=\"assets/Index_asset/Tien_ich_minh_hoa/Giao_tri_viet.png\" alt=\"Giáo Trí Việt & Vườn Cội\" style=\"width: 100%; border-radius: 8px; box-shadow: 0 4px 20px rgba(0,0,0,0.15);\">\n  <p style=\"font-size: 0.82rem; color: #888; text-align: center; margin-top: 6px; font-style: italic;\">Giáo Trí Việt – Nơi trẻ học bằng đôi tay và nuôi dưỡng tâm hồn trong sáng (* Hình ảnh minh họa)</p>\n</div>\n\n<h2>2. Tuổi Thơ Rực Rỡ Gió Hồ</h2>\n<p>Những buổi chiều lộng gió, hình ảnh cha con cùng nhau chạy trên bãi cỏ ven hồ 100ha để nâng cánh diều bay vút lên bầu trời xanh biếc sẽ là ký ức đẹp đẽ nhất đi theo các em suốt cả cuộc đời.</p>\n\n<div style=\"background: #111; color: #fff; padding: 28px; border-radius: 8px; border-left: 4px solid #c9a96e; margin-top: 30px;\">\n  <h4 style=\"margin-bottom: 8px; font-family: var(--font-serif); font-size: 1.25rem; color: #c9a96e;\">TỔNG ĐẠI LÝ TIẾP THỊ & PHÂN PHỐI: ĐẠI CHÚNG PROPERTIES</h4>\n  <p style=\"margin-bottom: 6px; font-size: 0.95rem;\">🏢 <strong>Phòng Kinh Doanh & Tư Vấn Dự Án:</strong> Saigon Farm Resort</p>\n  <p style=\"margin-bottom: 14px; font-size: 0.95rem;\">📞 <strong>Hotline / Zalo Tiếp Nhận Thông Tin:</strong> <a href=\"https://zalo.me/0906060036\" target=\"_blank\" style=\"color:#0068FF; font-weight:700; text-decoration:underline;\">0906060036</a></p>\n  <a href=\"https://zalo.me/0906060036\" target=\"_blank\" style=\"display: inline-flex; align-items: center; gap: 8px; background: #0068FF; color: #fff; padding: 12px 24px; border-radius: 4px; font-weight: 700; text-decoration: none;\">\n    <i class=\"fa-solid fa-comment-dots\"></i> Nhắn Zalo Nhận Bảng Giá & Đặt Lịch Trải Nghiệm\n  </a>\n</div>\n"
    },
    {
        "id": 211,
        "title": "Âm Sắc Việt & Không Gian Sinh Hoạt Cộng Đồng: Đánh Thức Hồn Dân Tộc Trong Nhịp Sống Đương Đại",
        "excerpt": "Nhà Âm Sắc Việt và Quảng trường Hội Việt: Không gian trưng bày trang phục và nhạc cụ 54 dân tộc, chợ phiên quê cuối tuần và những đêm hòa nhạc acoustic dân gian dưới trời sao.",
        "image": "assets/Index_asset/Tien_ich_minh_hoa/Nha_am_sac_viet.png",
        "date": "30 TH8 2026",
        "content": "\n<p>Bản sắc văn hóa không bao giờ là một bảo tàng tĩnh lặng phủ bụi thời gian, mà là một <strong>dòng chảy sống động tiếp tục hiện diện trong sinh hoạt hằng ngày</strong>. Tại <strong>Nhà Âm Sắc Việt (The Sound & Silk House)</strong> và <strong>Quảng Trường Hội Việt (The Village Green)</strong>, cư dân và du khách được hòa mình vào không gian nghệ thuật và lễ hội dân gian đặc sắc.</p>\n\n<div class=\"key-takeaways\">\n  <h3>Không Gian Giao Lưu Văn Hóa & Nghệ Thuật Độc Đáo</h3>\n  <ul>\n    <li><strong>Phòng trưng bày 54 sắc tộc:</strong> Bộ sưu tập trang phục gấm lụa, thổ cẩm tinh xảo và các loại nhạc cụ dân tộc cổ truyền như đàn bầu, đàn tranh, cồng chiêng, sáo trúc.</li>\n    <li><strong>Sân khấu hòa nhạc acoustic ngoài trời:</strong> Những đêm nhạc thính phòng giao hưởng kết hợp âm nhạc dân gian đương đại dưới vòm trời sao ven hồ.</li>\n    <li><strong>Chợ phiên quê Hội Việt cuối tuần:</strong> Tái hiện chợ phiên truyền thống với đặc sản vùng miền, bánh quê, nông sản sạch và các trò chơi dân gian rộn rã.</li>\n    <li><strong>Lễ hội bốn mùa ven hồ:</strong> Lễ hội thả hoa đăng cầu an rằm tháng Giêng, Tết Trung Thu rước đèn ông sao, hội mùa lúa chín tháng 10.</li>\n  </ul>\n</div>\n\n<h2>1. Gallery Sống Động Của Trang Phục & Thanh Âm</h2>\n<p>Nhà Âm Sắc Việt được bài trí như một phòng khách văn hóa mở, nơi các nghệ nhân biểu diễn trực tiếp và kể lại câu chuyện lịch sử đằng sau từng thớ vải lụa Hà Đông, từng hoa văn thổ cẩm Tây Bắc. Du khách có thể khoác lên mình trang phục truyền thống để lưu lại những khoảnh khắc kỷ niệm tuyệt đẹp.</p>\n\n<div style=\"margin: 28px 0; text-align: center;\">\n  <img src=\"assets/Index_asset/Tien_ich_minh_hoa/Nha_am_sac_viet.png\" alt=\"Nhà Âm Sắc Việt\" style=\"width: 100%; border-radius: 8px; box-shadow: 0 4px 20px rgba(0,0,0,0.15);\">\n  <p style=\"font-size: 0.82rem; color: #888; text-align: center; margin-top: 6px; font-style: italic;\">Nhà Âm Sắc Việt – Nơi lưu giữ thanh âm và trang phục truyền thống 54 dân tộc (* Hình ảnh minh họa)</p>\n</div>\n\n<h2>2. Quảng Trường Hội Việt – Trái Tim Kết Nối Cộng Đồng Tinh Hoa</h2>\n<p>Quảng trường Hội Việt là nơi những cư dân ưu tú cùng gặp gỡ, chia sẻ quan điểm sống và tận hưởng những giây phút giao lưu văn hóa ấm áp tình làng nghĩa xóm trong một chuẩn mực văn minh, tao nhã.</p>\n\n<div style=\"background: #111; color: #fff; padding: 28px; border-radius: 8px; border-left: 4px solid #c9a96e; margin-top: 30px;\">\n  <h4 style=\"margin-bottom: 8px; font-family: var(--font-serif); font-size: 1.25rem; color: #c9a96e;\">TỔNG ĐẠI LÝ TIẾP THỊ & PHÂN PHỐI: ĐẠI CHÚNG PROPERTIES</h4>\n  <p style=\"margin-bottom: 6px; font-size: 0.95rem;\">🏢 <strong>Phòng Kinh Doanh & Tư Vấn Dự Án:</strong> Saigon Farm Resort</p>\n  <p style=\"margin-bottom: 14px; font-size: 0.95rem;\">📞 <strong>Hotline / Zalo Tiếp Nhận Thông Tin:</strong> <a href=\"https://zalo.me/0906060036\" target=\"_blank\" style=\"color:#0068FF; font-weight:700; text-decoration:underline;\">0906060036</a></p>\n  <a href=\"https://zalo.me/0906060036\" target=\"_blank\" style=\"display: inline-flex; align-items: center; gap: 8px; background: #0068FF; color: #fff; padding: 12px 24px; border-radius: 4px; font-weight: 700; text-decoration: none;\">\n    <i class=\"fa-solid fa-comment-dots\"></i> Nhắn Zalo Nhận Bảng Giá & Đặt Lịch Trải Nghiệm\n  </a>\n</div>\n"
    },
...
<div class="key-takeaways">
  ...
  <ul>
    <li><strong>Cụm sân Pickleball:</strong> Mặt sân cao cấp, hệ thống chiếu sáng đạt chuẩn cho các trận giao lưu sôi nổi.</li>
    <li><strong>Đường chạy bộ ven hồ 3.2km:</strong> Cung đường lát đá rợp bóng cây, không khí trong lành lý tưởng cho chạy bộ sáng sớm.</li>
    <li><strong>Gym ngoài trời & Khu calisthenics:</strong> Rèn luyện thể lực giữa thiên nhiên thoáng đãng.</li>
  </ul>
</div>
...
"""
    ...
    # -------------------------------------------------------------
    {
        ...
        "excerpt": "Vị trí chiến lược tại Đất Đỏ - Liền kề Hồ Tràm, kết nối hoàn hảo với hệ thống cao tốc Biên Hòa - Vũng Tàu và sân bay quốc tế Long Thành.",
        "image": "assets/Index_asset/MatBang/SoDo_LienKet_Vung.png",
        "date": "29 TH8 2026",
        "content": """
<p><strong>Saigon Farm Resort</strong> sở hữu tọa độ phong thủy độc tôn "Tựa Hồ - Hướng Biển" tại huyện Đất Đỏ, tỉnh Bà Rịa - Vũng Tàu. Nằm liền kề cung đường biển tỷ đô Hồ Tràm - Bình Châu, resort hưởng trọn không gian sinh thái nguyên sơ nhưng chỉ cách TP.HCM chưa đầy 60 phút lái xe qua các trục giao thông huyết mạch.</p>

<div class="key-takeaways">
  <h3>Kết Nối Giao Thông Đột Phá 2026</h3>
  <ul>
    <li><strong>Cao tốc Biên Hòa - Vũng Tàu:</strong> Rút ngắn thời gian di chuyển từ TP.HCM xuống dưới 60 phút.</li>
    <li><strong>Sân bay Quốc tế Long Thành:</strong> Cách resort chỉ 35 phút, đón đầu lượng khách du lịch quốc tế và chuyên gia cao cấp.</li>
    <li><strong>Tuyến ven biển Quốc lộ 55 & ĐT 997:</strong> Kết nối trực tiếp chuỗi resort 5 sao Hồ Tràm, suối khoáng nóng Bình Châu và sân golf The Bluffs.</li>
  </ul>
</div>

<div style="margin: 24px 0; text-align: center;">
  <img src="assets/Index_asset/MatBang/SoDo_LienKet_Vung.png" alt="Sơ đồ liên kết vùng hạ tầng giao thông" style="width: 100%; border-radius: 8px; border: 1px solid #333;">
</div>
...
"""
    },
    {
        ...
        "excerpt": "Hỗ trợ xe đưa đón tận nơi từ TP.HCM xuống tham quan và trải nghiệm thực tế không gian điền trang nghỉ dưỡng ven hồ.",
...
<div style="margin: 24px 0; text-align: center;">
  <img src="assets/Index_asset/Flycam/DJI_0007_2.JPG" alt="Không gian thiên nhiên thực tế tại Saigon Farm Resort" style="width: 100%; border-radius: 8px; box-shadow: 0 4px 15px rgba(0,0,0,0.1);">
  <p style="font-size: 0.88rem; color: #777; margin-top: 8px; font-style: italic;">Khung cảnh thanh bình thực tế tại khu nghỉ dưỡng Saigon Farm Resort</p>
</div>
